                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td><strong>{{ number_format($totalAmountWithDiscount - $totalDiscount, 2) }}</strong></td>
                                            </tr>
                                        </tfoot>
                                    </table>
                                @endif
                ...
                <div class="col-md-12">
                    <div class="col-6 mt-3 w-100">
                        <form action="{{ route('profoma.cancell.invoice') }}" method="POST">
                            ...
                            <button type="submit" class="btn" style="background-color: red; border-color: orange; color: #FFF;">
                                Cancel Profoma
                            </button>
