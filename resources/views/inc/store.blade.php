                        ...
                        <div class="card-body">
                            <form action="{{ route('store.products') }}" method="POST" class="row"
                                ...
                                <div class="card-action">
                                    ...
                                    <a href="{{ route('download.file') }}" class="btn btn-secondary float-end">Download
                                        CSV</a>
                                </div>
                            </form>
                            <div class="card-header">
        ...
        <div class="shortcut-report">
            <div class="md-7">
                ...
                <button type="button" class="btn btn-secondary" onclick="regyStoreForm(event)"><i
                        class="fa fa-plus"></i>
                    Store</button>
                <button type="button" class="btn btn-secondary" onclick="RegProdForm(event)"><i class="fa fa-plus"></i>
                    Product</button>
                <br>
