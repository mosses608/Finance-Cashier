    ...
    <div class="row justify-content-center">
        <div class="col-md-4">
            <form action="{{ route('finalise.reset') }}" method="POST">
                @csrf
                <input type="hidden" name="username" class="form-control" id="username" value="{{ $username }}" required>
                ...
                <div class="mb-3 position-relative">
                    ...
                    <div class="input-group">
                        <input type="password" name="password_comfirm" class="form-control" id="password" placeholder="Re-enter new Password" minlength="8" required>
                        <span class="input-group-text">
                            <i class="fas fa-eye-slash" id="togglePassword" style="cursor: pointer;"></i>
                        </span>
                    </div>
