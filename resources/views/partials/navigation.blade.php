    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
            <ul class="nav nav-secondary">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#purchase-order">
                        ...
                        <ul class="nav nav-collapse">
                            <li>
                                <a href="{{ route('create.new.sales') }}">
                                    <span class="sub-item">Issue Purchase Order</span>
                                </a>
                            </li>
                            <li>
                        ...
                        <ul class="nav nav-collapse">
                            <li>
                                <a href="{{ route('create.invoice') }}">
                                    <span class="sub-item">Create Profoma Invoice</span>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="{{ route('invoice.adjustments') }}">
                                    <span class="sub-item">Profoma Adjustment</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('service.page') }}">
                                    <span class="sub-item">Sevices Management</span>
                                </a>
                            </li>
                            <li>
