    ...
    @elseif(session()->has('error_msg'))
        <div class="modal fade" id="successModal" tabindex="-1" aria-labelledby="successModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content bg-success text-white">
                    <div class="modal-header">
                        <h5 class="modal-title text-warning" id="successModalLabel">Error!</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
            ...
            <div class="container d-flex align-items-center justify-content-between">
                ...
                <a class="navbar-brand w-auto" href="/">
                    ...
                    <!-- logo dark--><img class="logo dark img-fluid" width="100px" height="70px"
                        src="{{ asset('assets/images/121616.png') }}" alt="FreeBootstrap.net image placeholder">
                ...
                <div class="offcanvas offcanvas-start w-75" id="fbs__net-navbars" tabindex="-1"
                        ...
                        <div class="offcanvas-header-logo">
                            ...
                            <a class="logo-link" id="fbs__net-navbarsLabel" href="/">
                                ...
                                <!-- logo light--><img class="logo light img-fluid"
                                    src="{{ asset('assets/images/121616.png') }}" alt="image placeholder"></a>
                    ...
                    <div class="offcanvas-body align-items-lg-center">
                        ...
                        <ul class="navbar-nav nav me-auto ps-lg-5 mb-2 mb-lg-0">
                            ...
                            <li class="nav-item"><a class="nav-link scroll-link" href="#how-it-works">How It
                                    Works</a>
                            </li>
                ...
                <div class="ms-auto w-auto">
                    ...
                    <div class="header-social d-flex align-items-center gap-1"><a class="btn btn-primary py-2"
                            href="{{ route('get.started') }}">Get Started</a>
                    ...
                    <div class="row">
                        <div class="col-lg-6 mb-4 mb-lg-0">
                            <div class="row">
                                <div class="col-lg-11"><span class="hero-subtitle text-uppercase" data-aos="fade-up"
                                        data-aos-delay="0">AkiliSoft Enterpise Recource Planning System</span>
                                    <h1 class="hero-title mb-3 fs-2" data-aos="fade-up" data-aos-delay="100">Smart,
                                        Secure, and user-friendly
                                        solution for managing and streamlining business operations</h1>
                                    <p class="hero-description mb-4 mb-lg-5" data-aos="fade-up" data-aos-delay="200">
                                        Experience the future of your enterpise services with our secure, efficient, and
                                        user-friendly
                                    ...
                                    {{-- <div class="logos mb-4" data-aos="fade-up" data-aos-delay="400"><span
                                        ...
                                        <div class="logos-images d-flex gap-4 align-items-center"><img
                                                ...
                                                src="{{ asset('assets/assets/images/logo/actual-size/logo-air-bnb__black.svg') }}"
                                                alt="Company 1" style="width: 110px;"><img
                                                class="img-fluid js-img-to-inline-svg"
                                                src="{{ asset('assets/assets/images/logo/actual-size/logo-ibm__black.svg') }}"
                                                alt="Company 2" style="width: 80px;"><img
                                                class="img-fluid js-img-to-inline-svg"
                                                src="{{ asset('assets/assets/images/logo/actual-size/logo-google__black.svg') }}"
                        ...
                        <div class="col-lg-6 mb-0">
                            <div class="hero-img"><img class="img-card img-fluid"
                                    src="{{ asset('assets/images/2112.i109.020.S.m004.c13.financial literacy budget planning isometric.jpg') }}"
                                    alt="Image card" data-aos="fade-down" data-aos-delay="600"><img
                                    class="img-main img-fluid rounded-4"
                                    src="{{ asset('assets/images/person-working-html-computer (1).jpg') }}"
                    ...
                    <div class="row">
                            ...
                            <div class="row justify-content-end">
                                <div class="col-md-11 mb-4 mb-md-0"><span class="subtitle text-uppercase mb-3"
                                    ...
                                    <h2 class="mb-4" data-aos="fade-up" data-aos-delay="100"> Experience the future
                                        of your enterpise services with our secure, efficient, and user-friendly
                                        financial services.</h2>
                                    <div data-aos="fade-up" data-aos-delay="200">
                                        <p>Founded with the vision of transforming business management, AkiliSoft is a
                                            leading ERP provider dedicated to delivering innovative, integrated, and
                                            secure enterprise solutions."

                                            Let me know if you'd like a version with a more technical or
                                            industry-specific tone.</p>
                                        <p>Our cutting-edge ERP platform ensures your operations are secure,
                                            streamlined, and easy to manage—empowering your business to take control of
                                            its processes with confidence and efficiency."

                                            Let me know if you'd like it to emphasize a specific ERP module like
                                            finance, HR, or inventory.</p>
                                    </div>
                                    ...
                                    <ul class="d-flex flex-row flex-wrap list-unstyled gap-3 features"
                                        ...
                                        <li class="d-flex align-items-center gap-2"><span
                                                class="icon rounded-circle text-center"><i
                                                    class="bi bi-check"></i></span><span class="text">Data-Driven
                                                Decisions</span></li>
                                        <li class="d-flex align-items-center gap-2"><span
                                                class="icon rounded-circle text-center"><i
                                                    class="bi bi-check"></i></span><span class="text">Integration &
                                                Flexibility</span></li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="img-wrap position-relative"><img class="img-fluid rounded-4"
                                    src="{{ asset('assets/images/3d-render-tax-payment-financial-business-concept (1).jpg') }}"
                                ...
                                <div class="mission-statement p-4 rounded-4 d-flex gap-4" data-aos="fade-up"
                                    ...
                                    <div>
                                        ...
                                        <p class="fs-5 mb-0">To deliver an intelligent, reliable, and adaptable ERP
                                            system that simplifies complex business processes, enhances operational
                                            visibility, and supports organizations in making faster, data-informed
                                            decisions no matter their size or industry.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div class="col-lg-11">
                                                <div class="h-100 flex-column justify-content-between d-flex">
                                                    <div>
                                                        ...
                                                        <p class="mb-5">At AkiliSoft ERP, we combine deep industry
                                                            expertise with cutting-edge technology to deliver a
                                                            powerful, customizable, and user-friendly ERP solution. Our
                                                            system is built to streamline your operations, enhance data
                                                            visibility, and support informed decision-making across all
                                                            departments. With a strong focus on reliability, security,
                                                            and customer support, we are committed to helping
                                                            organizations of all sizes unlock their full potential and
                                                            achieve operational excellence.."</p>
                                                    </div>
                    ...
                    <div class="row mb-5">
                        <div class="col-md-6 text-center mx-auto"><span class="subtitle text-uppercase mb-3"
                            ...
                            <p data-aos="fade-up" data-aos-delay="200">Our platform is designed to make managing your
                                entire organization—finances, operations, and resources—simple and efficient. Follow
                                these easy steps to get started with AkiliSoft ERP: </p>
                        </div>
                    </div>
                    <div class="row g-md-5">
                        <div class="col-md-6 col-lg-3">
                            <div class="step-card text-center h-100 d-flex flex-column justify-content-start position-relative"
                                ...
                                <div data-aos="fade-right" data-aos-delay="500"><img class="arch-line"
                                        src="{{ asset('assets/assets/images/arch-line.svg') }}"
                                        alt="FreeBootstrap.net image placeholder">
                                </div><span
                                    class="step-number rounded-circle text-center fw-bold mb-5 mx-auto">1</span>
                                <div>
                                    <h3 class="fs-5 mb-4">Sign Up / Get Started</h3>
                                    <p>Visit our system. Provide basic information to
                        ...
                        <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="600">
                            <div
                                ...
                                <div data-aos="fade-right" data-aos-delay="1100"><img class="arch-line reverse"
                                        src="{{ asset('assets/assets/images/arch-line-reverse.svg') }}"
                                        alt="FreeBootstrap.net image placeholder"></div><span
                                    class="step-number rounded-circle text-center fw-bold mb-5 mx-auto">2</span>
                                <h3 class="fs-5 mb-4">Set Up a Profile</h3>
                                <p>Add your business details to tailor the platform to your specific needs.
                                </p>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="1200">
                            <div
                                ...
                                <p>Access your dashboard for a summary of your ERP: daily sales, expenses, loans,
                                    income, recent transactions,
                                    and insights.</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="1800">
                            <div
                                ...
                                <div>
                                    <h3 class="fs-5 mb-4">ERP</h3>
                                    <p>Start using the ERP tailored to your enterpise goals.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row mb-5">
                        <div class="col-md-8 mx-auto text-center"><span class="subtitle text-uppercase mb-3"
                            ...
                            <h2 class="mb-3" data-aos="fade-up" data-aos-delay="100">Empowering Enterprise Growth
                                Through Integrated and Intelligent ERP Solutions.</h2>
                        </div>
                    </div>
                    <div class="row g-4">
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="0">
                            <div
                                ...
                                <div><span class="icon mb-4">
                                    ...
                                    <h3 class="fs-5 mb-3">Human Resources Management</h3>
                                    <p class="mb-4">Facilitates seamless and secure HR-related transactions—such as
                                        payroll processing, benefits disbursement, and reimbursements—across digital
                                        platforms, ensuring timely and convenient payments for employees and improved
                                        efficiency for businesses.</p>
                                </div><a
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                            <div
                                ...
                                <div><span class="icon mb-4">
                                    ...
                                    <h3 class="fs-5 mb-3">Company Finance Management</h3>
                                    <p class="mb-4">Enables seamless and secure financial transactions across
                                        multiple digital platforms, streamlining processes such as invoicing, vendor
                                        payments, and expense management for quicker and more efficient financial
                                        operations.</p>
                                </div><a
                                    class="special-link d-inline-flex gap-2 align-items-center text-decoration-none"
                                    href="#"><span class="icons"><i
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                            <div
                                ...
                                <div><span class="icon mb-4">
                                    ...
                                    <h3 class="fs-5 mb-3">Sales Management</h3>
                                    <p class="mb-4">Supports fast and accessible sales financing solutions, offering
                                        personal and business loan options through digital platforms to simplify the
                                        purchasing process and boost customer conversion.</p>
                                </div><a
                                    class="special-link d-inline-flex gap-2 align-items-center text-decoration-none"
                                    href="#"><span class="icons"><i
                                            class="icon-1 bi bi-arrow-right-short"></i><i
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                            <div
                                ...
                                <div><span class="icon mb-4">
                                    ...
                                    <h3 class="fs-5 mb-3">Budgets Management</h3>
                                    <p class="mb-4">Provides intuitive tools for planning, allocating, and tracking
                                        budgets, empowering businesses to manage financial resources effectively and
                                        make informed investment decisions with ease.</p>
                                </div><a
                                    class="special-link d-inline-flex gap-2 align-items-center text-decoration-none"
                                    href="#"><span class="icons"><i
                                            class="icon-1 bi bi-arrow-right-short"></i><i
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="500">
                            <div
                                ...
                                <div><span class="icon mb-4">
                                    ...
                                    <h3 class="fs-5 mb-3">Inventory Management</h3>
                                    <p class="mb-4">Streamlines inventory tracking, stock movement, and replenishment
                                        processes, ensuring accurate control of goods and seamless coordination across
                                        procurement, storage, and sales operations.</p>
                                </div><a
                                    class="special-link d-inline-flex gap-2 align-items-center text-decoration-none"
                                    href="#"><span class="icons"><i
                                            class="icon-1 bi bi-arrow-right-short"></i><i
                        ...
                        <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="600">
                            <div
                                ...
                                <div><span class="icon mb-4">
                                    ...
                                    <h3 class="fs-5 mb-3">Revenue Collection</h3>
                                    <p class="mb-4">Leverages digital tools to automate billing, track receivables,
                                        and streamline payment collection, ensuring timely revenue generation and
                                        improved financial transparency for the organization.</p>
                                </div><a
                                    class="special-link d-inline-flex gap-2 align-items-center text-decoration-none"
                                    href="#"><span class="icons"><i
                                            class="icon-1 bi bi-arrow-right-short"></i><i
                            ...
                            <div class="d-flex gap-5 flex-column">
                                ...
                                <div class="d-flex align-items-start gap-3" data-aos="fade-up" data-aos-delay="100">
                                    <div class="icon d-block"><i class="bi bi-send"></i></div><span> <span
                                            class="d-block">Email</span><strong>info@akilisofterp.com</strong></span>
                                </div>
