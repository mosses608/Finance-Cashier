                        ...
                        <div class="card-header">
                            ...
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab"
                                    ...
                                    aria-selected="true">New Applications List</button>
                                <button class="nav-link" id="nav-home-tab" data-bs-toggle="tab"
                                    data-bs-target="#nav-out-profoma" type="button" role="tab" aria-controls="nav-home"
                                    aria-selected="true">Approved Applications
                                </button>
                            </div>
                        </div>
                        <div class="card-body">
                                                ...
                                                @foreach ($leaveApplications as $application)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <form action="{{ route('approve.leave.request') }}"
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h1 class="modal-title fs-5"
                                                                                ...
                                                                                {{ number_format($application->days) . ' ' . 'leave days' }}
                                                                            </h1>
